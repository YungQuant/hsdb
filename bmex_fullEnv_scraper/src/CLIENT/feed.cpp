...
{ 
    ...
    items.push_back("orderBookL2:ADAM19");
    items.push_back("orderBookL2:BCHM19");
    items.push_back("orderBookL2:EOSM19");
    items.push_back("orderBookL2:ETHUSD");
    items.push_back("orderBookL2:LTCM19");
    items.push_back("orderBookL2:TRXM19");
    items.push_back("orderBookL2:XRPM19");
